...
from account.v1.views.profile import ProfileAPIView, PasswordResetAPIView, ProfileUserDataAPIView, ProfileKYCAPIView
...
urlpatterns = [
    ...
    path("kyc", ProfileKYCAPIView.as_view(), name='kyc'),
]
